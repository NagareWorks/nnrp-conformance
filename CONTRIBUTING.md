...
- `cargo run -p nnrp-conformance-runner -- summary --protocol protocol/nnrp-1-preview3/manifest.json --cases protocol/nnrp-1-preview3/cases/mandatory-core.json --capabilities protocol/nnrp-1-preview3/example-capabilities.json` when changing baseline selection, manifests, or report shape
