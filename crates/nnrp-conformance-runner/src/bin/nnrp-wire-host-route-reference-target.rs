...
async fn main() -> Result<()> {
    ...
    let result = run_case(&scenario, &resolved, &args.artifacts, &args.ready_output).await;
...
#[cfg(test)]
mod tests {
    use super::rollback_probe_policy;
    use nnrp_conformance_fixtures::{
        WireConformanceTransport, WireHostCredentialOwner, WireHostProviderRoute,
