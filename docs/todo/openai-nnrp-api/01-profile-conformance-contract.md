...
- [x] Freeze Level 1 mandatory case ids.
- [x] Freeze Level 1 optional case ids.
- [x] Freeze Level 1 extension-case selection rules.
- [x] Define how Level 1 maps onto a selected NNRP protocol baseline.

## Extension Discipline

- [x] Require provider extensions to be declared in the API capability manifest.
- [x] Distinguish `critical` extension cases from ignorable non-critical extension fields.
